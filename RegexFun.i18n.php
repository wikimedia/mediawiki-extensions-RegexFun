 ...
 */
$messages['mk'] = array(
	'regexfun-desc' => 'Додава расчленувачки функции што овозможуваат употреба на регуларни изрази во вики-траници',
...
$messages['ru'] = array(
	...
	'regexfun-limit-exceed' => 'Достигнуто максимальное количество в {{PLURAL:$1|$1 обращение|$1 обращений|$1 обращения}} к регулярным выражениям «Regex Fun».',
);
